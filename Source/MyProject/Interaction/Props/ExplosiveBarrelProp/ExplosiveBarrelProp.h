...
#include "MyProject/Interaction/Props/InteractivePropBase/InteractivePropBase.h"
#include "ExplosiveBarrelProp.generated.h"

/**
 * Wybuchająca beczka fizyczna.
 * Po zniszczeniu (spadek HP do 0 / silne zderzenie) detonuje wybuch z użyciem UCombatForceLibrary.
 */
UCLASS()
