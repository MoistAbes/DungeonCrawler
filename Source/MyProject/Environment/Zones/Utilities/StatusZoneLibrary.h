...
#include "MyProject/Environment/Zones/StatusZone.h"
...
public:
	 ...
	 * Spawnuje strefę o grubości SurfaceHeight (domyślnie 25 cm) i przypina ją (AttachToComponent) do trafionego obiektu.
	...
	static AStatusZone* ApplySurfaceSplash(
	 ...
	 * Tworzy pełną bryłę sferyczną zawieszoną w powietrzu na określony czas (np. trujący gaz, dym, strefa uciszenia magii).
	 */
	UFUNCTION(BlueprintCallable, Category = "Environment|Zones|Delivery", meta = (WorldContext = "WorldContextObject"))
	static AStatusZone* SpawnVolumetricZone(
		const UObject* WorldContextObject,
